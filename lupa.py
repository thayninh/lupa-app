...
def run():
    try:
        ...
        fuzzy_results_file = "{}\\fuzzy_raster_result.py".format(current_path)
        with open(fuzzy_results_file,'w+') as f:
            f.write("fuzzy_raster_result = {0}\neuclidean_results = {1}".format(fuzzy_raster_result, euclidean_results))
